...
insert into restaurante (nome, taxa_frete, cozinha_id, forma_pagamento_id, permissao_id, estado_id, cidade_id ) values (' Thai Gourmet', 10, 1, 3, 1, 1, 1);
insert into restaurante (nome, taxa_frete, cozinha_id, forma_pagamento_id, permissao_id, estado_id, cidade_id ) values (' Thai Delivery', 9.50, 1, 2, 3, 3, 3);
insert into restaurante (nome, taxa_frete, cozinha_id, forma_pagamento_id, permissao_id, estado_id, cidade_id ) values (' Tuk Tuk Comida Indiana', 15, 2, 1, 4, 4, 4);